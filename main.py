#Uzrakstit programmu, kas pieprasa no lietotāja ievadīt tris leņķus (kas varētu piederēt vienam trīsstūrim) un ar funkcijas palīdzību pārbauda, vai šie leņķi ir derīgi trīsstūra veidošanai.
